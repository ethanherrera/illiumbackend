...
@SpringBootTest
class TechniqueRepositoryTests {

    @Autowired
    private lateinit var techniqueRepository: TechniqueRepository

    @Test
    fun `populate techniques from file`() {
        val techniques = listOf(
            // -- LEVEL 1 (in original appearance order) --
        ...
        val savedTechniques = techniqueRepository.findAll()
        assertEquals(techniques.size, savedTechniques.size)
    }
}
